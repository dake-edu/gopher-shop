...
<!-- include:examples/09-errors/labs/01-functions/main.go -->

```sh
go run ./labs/01-functions
```

<!-- include:examples/09-errors/labs/01-functions/stdout.txt -->
...
<!-- include:examples/09-errors/labs/03-errors/main.go -->

```sh
go run ./labs/03-errors
```

<!-- include:examples/09-errors/labs/03-errors/stdout.txt -->
...
<!-- include:examples/09-errors/labs/02-defer/main.go -->

```sh
go run ./labs/02-defer
```

<!-- include:examples/09-errors/labs/02-defer/stdout.txt -->
