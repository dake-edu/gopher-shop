...
В `title_test.go` есть проверка строки из восьмидесяти букв `Ә`. Она занимает сто шестьдесят байтов, но должна пройти наш лимит в рунах. Следующая проверка добавляет ещё одну такую букву и ожидает отказ.
