...
Статус: **рабочая редакция 0.4**, вступление и главы 1–8. Полная программа содержит 42 главы на уровнях Junior, Middle и Senior. Книга и итоговый магазин ещё не завершены.
...
Редакция 0.4 начинается с авторской обложки, титула и выходных сведений. Автор — Баймурзин Даулет Абузарович. HTML открывается с обложки, оглавление и поиск — в `build/preview/html/toc.html`. [Издательское оформление](editorial/front-matter.md).
