...
Статус: **рабочая редакция 0.5.1**, вступление и главы 1–9. Полная программа содержит 42 главы на уровнях Junior, Middle и Senior. Книга и итоговый магазин ещё не завершены.
...
## Для самостоятельного читателя

Начните с предисловия: там указаны границы выпуска, порядок работы с контрольными точками и критерии перехода. Для запуска примеров достаточно Go; Python нужен только для издательской сборки. Готовый [ZIP кода](build/preview/go-book-preview-code.zip) создаётся вместе с форматами и содержит инструкцию запуска.

[Аудит от 16 сентября 2026](editorial/audit-2026-09-16.md) перечисляет исправления, проверки и оставшиеся ограничения.
