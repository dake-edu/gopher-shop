...
Уже написаны вступление и главы 1–8. Контрольные точки проверяются на Go 1.27.1; PDF, EPUB и офлайн-HTML собираются из одного текста. Это рабочая редакция, а не законченный магазин. [Программа](book/editorial/blueprint.md) и [состояние работы](book/CONTINUE.md).
